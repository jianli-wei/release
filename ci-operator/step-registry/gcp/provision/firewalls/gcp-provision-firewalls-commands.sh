...
create_firewall_rules "${CLUSTER_NAME}" "${CLUSTER_NETWORK}" "${NETWORK_CIDR}" "0.0.0.0/0" "${CONTROL_PLANE_NODES_TAGS}" "${COMPUTE_NODES_TAGS}" "${FIREWALL_RULES_DEPROVISION_SCRIPTS}"
